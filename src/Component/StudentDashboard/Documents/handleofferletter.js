...
export const handleofferletter = async (user) => {
  // setloader(true);
      ...
      <div class="container">
        <div class="box">
          ...
          <div class="content">
            ...
            <p>
              Congratulations! We are delighted to offer you a position as a ${
                user.sector
              }.
            </p>
            <p>Below are the terms and conditions of our offer:</p>
            <p>
              Your internship is scheduled to commence on ${
                user.Start_Date
              }. Upon acceptance of this offer, you will assume the role
          ...
          <div class="stampsignature">
            <div class="contact">
              <p>Contact: dynamoscode@gmail.com</p>
