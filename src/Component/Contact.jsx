          ...
          <section className="sm:w-1/2  flex flex-col p-4 w-screen">
            ...
            <div className="flex flex-col ">
              <div className="mb-2 text-gray-700 flex  justify-around">
                ...
                <div className="w-[200px]">contact@example.com</div>
              </div>
              <div className="mb-2 text-gray-700 flex justify-around">
                <div className="font-semibold w-[100px]">Phone:</div>
                <div className="w-[200px]">(123) 456-7890</div>
              </div>
              <div className="text-gray-700 flex justify-around">
                <div className="font-semibold w-[100px]">Address:</div>
                <div className="w-[200px]">123 Main St, City, Country</div>
              </div>
            </div>
          </section>
